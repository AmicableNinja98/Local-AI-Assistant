...
TOOLS = [
    ...
    {"type": "function", "function": {"name": "inscribir_equipo_en_torneo", "description": "Inscribe un equipo existente en un torneo existente.", "parameters": {"type": "object", "properties": {"nombre_equipo": {"type": "string"}, "nombre_torneo": {"type": "string"}}, "required": ["nombre_equipo", "nombre_torneo"]}}},
    {"type": "function", "function": {"name": "inscribir_jugador_en_torneo", "description": "Registra un jugador existente en un torneo existente.", "parameters": {"type": "object", "properties": {"nombre_jugador": {"type": "string"}, "nombre_torneo": {"type": "string"}}, "required": ["nombre_jugador", "nombre_torneo"]}}},
...
FUNCIONES_MAPA = {
    ...
    "inscribir_jugador_en_torneo": inscribir_jugador_en_torneo,
